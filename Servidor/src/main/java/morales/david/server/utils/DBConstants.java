...
public class DBConstants {
    ...
    public static final String DB_QUERY_EMPTYCLASSROOMSTIMEZONE = "SELECT * FROM aula WHERE aula.id_aula NOT IN (SELECT aula FROM imparte WHERE franja = ? AND aula IS NOT NULL)";
