...
public class GroupsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(getString(R.string.act_groups_title));
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        ActionBarUtil.changeStyle(this, getSupportActionBar());

        recyclerView = findViewById(R.id.act_groups_recyclerview);
        ...
        courseDropDown = findViewById(R.id.act_groups_spinner_course);
        ...
        unfilterImageView = findViewById(R.id.act_groups_unfilter);
